    ...
    , max_rows_per_postings_list(max_rows_per_postings_list_)
{
    ...
    if (!std::unordered_set<String>{GIN_TOKENIZER_DEFAULT, GIN_TOKENIZER_NONE, GIN_TOKENIZER_NGRAM, GIN_TOKENIZER_CHINESE}.contains(
            tokenizer))
        throw Exception(
            ErrorCodes::BAD_ARGUMENTS,
            "The tokenizer of gin index must be one of these [{}, {}, {}, {}]",
            GIN_TOKENIZER_DEFAULT,
            GIN_TOKENIZER_NONE,
            GIN_TOKENIZER_NGRAM,
            GIN_TOKENIZER_CHINESE);
}
