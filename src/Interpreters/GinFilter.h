...
static inline constexpr String GIN_TOKENIZER_DEFAULT = "default";
static inline constexpr String GIN_TOKENIZER_NONE = "none";
static inline constexpr String GIN_TOKENIZER_NGRAM = "ngram";
static inline constexpr String GIN_TOKENIZER_CHINESE = "chinese";
